...
(define-key evil-normal-state-map "E" 'evil-join)
...
(define-key evil-normal-state-map "gK" 'evil-insert-0-line)
(define-key evil-normal-state-map "gE" 'evil-join-whitespace)
...
(define-key evil-normal-state-map "\C-h" 'evil-paste-pop-next)
...
(define-key evil-window-map "\C-h" 'evil-window-new)
...
(define-key evil-motion-state-map "N" 'evil-window-top)
...
(define-key evil-motion-state-map "I" 'evil-lookup)
...
(define-key evil-motion-state-map "ge" 'evil-next-visual-line)
...
(define-key evil-motion-state-map "gl" 'evil-goto-char)
...
(define-key evil-motion-state-map [?z right] "zo")
(define-key evil-motion-state-map "zn" 'evil-scroll-column-left)
(define-key evil-motion-state-map [?z left] "zn")
(define-key evil-motion-state-map "zO" 'evil-scroll-right)
(define-key evil-motion-state-map "zN" 'evil-scroll-left)
...
(define-key evil-motion-state-map "gh" 'evil-next-match)
(define-key evil-motion-state-map "gH" 'evil-previous-match)
...
(defvar evil-insert-state-bindings
  `(([insert] . evil-replace-state)
    ...
    ("\C-i" . evil-insert-digraph)
    ("\C-l" . evil-execute-in-normal-state)
    ("\C-r" . evil-paste-from-register)
    ("\C-y" . evil-copy-from-above)
    ("\C-j" . evil-copy-from-below)
    ...
    ,@(when evil-want-C-h-delete
        '(("\C-n" . evil-delete-backward-char-and-join)))
...
(when evil-want-C-h-delete
  (define-key evil-replace-state-map "\C-n" 'evil-replace-backspace))
...
(define-key evil-ex-search-keymap "\C-i" 'evil-insert-digraph)
...
(define-key evil-ex-search-keymap "\C-h" 'next-history-element)
...
(define-key evil-ex-completion-map "\C-i" 'evil-insert-digraph)
...
(define-key evil-ex-completion-map "\C-h" #'next-complete-history-element)
...
(define-key evil-read-key-map (kbd "C-i") #'evil-read-digraph-char)
